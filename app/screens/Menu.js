        ...
        <ScrollView>
            <View style={styles.background}>
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Indian{"\n\n"}</Text></View>
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Chinese{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Others{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                        {"      "} Sandwich{"\n"}
                        {"      "} Granola cups{"\n"}
...
function Mess() {
    return (
        <ScrollView>
            <View style={styles.background}>
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Monday{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Tuesday{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                        <Text style={{ fontSize: screenHeight / 35 }}>Breakfast:</Text>
                        {"\n      "}Scrambled farm-eggs {"\n"}
                        {"      "}Lightly smoked back-meat {"\n"}
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Thursday{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                        <Text style={{ fontSize: screenHeight / 35 }}>Breakfast:</Text>
                        {"\n      "}Scrambled farm-eggs {"\n"}
                        {"      "}Lightly smoked back-meat {"\n"}
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Friday{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                        <Text style={{ fontSize: screenHeight / 35 }}>Breakfast:</Text>
                        {"\n      "}Scrambled farm-eggs {"\n"}
                        {"      "}Lightly smoked back-meat {"\n"}
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Saturday{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                        <Text style={{ fontSize: screenHeight / 35 }}>Breakfast:</Text>
                        {"\n      "}Scrambled farm-eggs {"\n"}
                        {"      "}Lightly smoked back-meat {"\n"}
                ...
                <View style={styles.card}>
                    <View style={styles.heading}><Text style={{ color: "#191E1D", fontWeight: "bold", fontSize: screenHeight / 45, marginTop: "30%" }}>Sunday{"\n\n"}</Text></View>
                    <Text style={styles.text}>
                        <Text style={{ fontSize: screenHeight / 35 }}>Breakfast:</Text>
                        {"\n      "}Scrambled farm-eggs {"\n"}
                        {"      "}Lightly smoked back-meat {"\n"}
